...
func main() {
	// Example usage:
	// Add students
	sm.Enroll(Student{Id: 1, Name: "Alice", Age: 20, GPA: 3.5, Password: "pass1"})
	sm.Enroll(Student{Id: 2, Name: "Bob", Age: 21, GPA: 3.2})
	sm.Enroll(Student{Id: 3, Name: "Charlie", Age: 22, GPA: 3.9})

	// registering the end-point/route (/greet) with the request multiplexer
	http.HandleFunc("/greet", greetHandler)
	http.HandleFunc("/students", studentHandlerPrem)
...
*/
func studentHandlerPrem(w http.ResponseWriter, r *http.Request) {
